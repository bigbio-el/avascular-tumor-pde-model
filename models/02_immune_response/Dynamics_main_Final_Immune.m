...
Dl = 5;                          % lymphocytes diffusion coefficient
alpha = 0.8;                     % 
...
k4 = 1;                          % correlation coefficient reflecting a rate of lymphocytes death after contacting proliferating cells
k5 = 0.55;                       % correlation coefficient reflecting a rate of proliferating cells death after contacting lymphocytes
...
c0 = 1;                          % nutrient concentration in the absence of a tumour cell population
                                 % oxygen concentration in the absence of a
...
x = [p;zeros(N,1);zeros(N,1);s;ones(N,1);ones(N,1)];
...
x = x + (myfun(x,DX,Dc,Dl,alpha,gamma,k1,k2,k3,k4,k5,k6,lv,c0,N) * h);
...
figure ; plot(XX,L75,XX,L150,XX,L225,XX,L300,XX,L375,XX,L450,XX,L525) ; grid on ; title('Enlarged model of an avascular tumour growth') ; xlabel('Space x, cm') ; ylabel('Immune cells, l');
